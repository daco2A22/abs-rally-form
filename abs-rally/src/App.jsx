        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-3xl items-center px-6 py-10">
          <div className="w-full overflow-hidden rounded-2xl border border-[#242424] bg-[linear-gradient(180deg,#151515_0%,#101010_100%)] shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-sm">
            ...
            <div className="p-8 text-center md:p-12">
              <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full border-2 border-[#f0b429] bg-[rgba(240,180,41,0.10)] text-4xl text-[#f0b429] shadow-[0_0_35px_rgba(240,180,41,0.20)]">✓</div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex flex-col gap-5 md:flex-row md:items-center">
              <img src="/abs.png" alt="ABS Rallye" className="h-44 w-44 shrink-0 object-contain drop-shadow-[0_0_35px_rgba(240,180,41,0.6)] transition duration-300 hover:scale-[1.03] md:h-52 md:w-52" />
            ...
            <div className="flex items-center justify-center xl:justify-end">
              <img src="/afrl.png" alt="AFRL" className="h-36 object-contain opacity-95 transition duration-300 hover:scale-[1.02] md:h-44" />
            </div>
          </div>
        </div>
      </header>
                  ...
                  <div className="grid gap-2 p-2 md:grid-cols-2">
                    {currentClass.cars.map((car) => {
                      ...
                      return (
                        ...
                        >
                          <span className="flex h-4 w-4 items-center justify-center rounded-full border-2 transition duration-200" style={{ borderColor: picked ? currentClass.color : "#444", background: picked ? currentClass.color : "transparent", boxShadow: picked ? `0 0 10px ${currentClass.color}66` : "none" }}>
          ...
          <aside className="xl:sticky xl:top-6 xl:h-fit">
            <div className="overflow-hidden rounded-2xl border border-[#242424] bg-[linear-gradient(180deg,#151515_0%,#111_100%)] shadow-[0_12px_50px_rgba(0,0,0,0.35)] backdrop-blur-sm">
              ...
              <div className="space-y-3 p-5">
                ...
                <button onClick={handleSubmit} className="mt-2 w-full rounded-xl bg-[#f0b429] px-6 py-4 text-lg font-black uppercase tracking-[2px] text-white shadow-lg transition duration-200 hover:-translate-y-1 hover:brightness-105 active:translate-y-0">
                  VALIDER / SUBMIT →
                </button>
              </div>
            </div>
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute right-[10%] top-[20%] h-80 w-80 animate-pulse rounded-full bg-[#5865F2]/10 blur-3xl" style={{ animationDuration: "7s" }} />
        <div className="absolute bottom-[10%] left-[18%] h-64 w-64 animate-pulse rounded-full bg-white/5 blur-3xl" style={{ animationDuration: "9s" }} />
        <div className="absolute bottom-[18%] right-[12%] h-72 w-72 animate-pulse rounded-full bg-[#f0b429]/8 blur-3xl" style={{ animationDuration: "11s" }} />
      </div>
